...
def test_validate_params_warns_on_celsius_like_values():
    print("\nTesting Celsius-like inputs that should trigger warnings...")
...
def test_validate_refrigerant_fail():
    print("\nTesting invalid refrigerant name...")
...
def test_cop_scalar():
    print("\nTesting SingleFluidCOP scalar computation...")
...
def test_plotting_fallback_without_matplotlib(monkeypatch):
    ...
    dummy_logger = types.SimpleNamespace(warning=lambda msg: print(f"Logged warning: {msg}"))
